...
plot \
  'bigloo_mem_rumney.csv' u 2:xtic(1) title 'Scheme self tagging (1 tag)' ls 2,\
  'bigloo_mem_rumney.csv' u 3:xtic(1) title 'Scheme self tagging (2 tags)' ls 3,\
  'bigloo_mem_rumney.csv' u 4:xtic(1) title 'Scheme self tagging (3 tags)' ls 4,\
  'bigloo_mem_rumney.csv' u 5:xtic(1) title 'Scheme nan tagging' ls 5,\
  'bigloo_mem_rumney.csv' u 6:xtic(1) title 'orig_nun' ls 6,\
  'bigloo_mem_rumney.csv' u ($0+-0.5):($2+.1):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_rumney.csv' u ($0+-0.3333333333333333):($3+.1):(sprintf("%3.2f",$3)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_rumney.csv' u ($0+-0.16666666666666666):($4+.1):(sprintf("%3.2f",$4)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_rumney.csv' u ($0+0):($5+.1):(sprintf("%3.2f",$5)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_rumney.csv' u ($0+0.16666666666666666):($6+.1):(sprintf("%3.2f",$6)) with labels font 'Verdana,6' rotate by 90 notitle

reset

set output 'bigloo_mem_rumney.pdf'
