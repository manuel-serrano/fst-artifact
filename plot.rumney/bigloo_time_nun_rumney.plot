...
plot \
   'bigloo_time_nun_rumney.csv' u 2:xtic(1) title 'self-tagging (1-tag)' ls 1,\
   'bigloo_time_nun_rumney.csv' u 3:xtic(1) title 'self-tagging (2-tag)' ls 2,\
   'bigloo_time_nun_rumney.csv' u 4:xtic(1) title 'self-tagging (3-tag)' ls 3,\
   'bigloo_time_nun_rumney.csv' u 5:xtic(1) title 'NaN-boxing' ls 4, \
   'bigloo_time_nun_rumney.csv' u ($0+-0.3333333333333333):($2+.15):(sprintf("%3.2f",$2)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'bigloo_time_nun_rumney.csv' u ($0+-0.16666666666666666):($3+.15):(sprintf("%3.2f",$3)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'bigloo_time_nun_rumney.csv' u ($0+0.16666666666666666):($4+.15):(sprintf("%3.2f",$4)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'bigloo_time_nun_rumney.csv' u ($0+0.3333333333333333):($5+.15):(sprintf("%3.2f",$5)) with labels font 'Verdana,4' rotate by 90 notitle
reset

set output 'bigloo_time_nun_rumney.pdf'
