#!/bin/sh
#*=====================================================================*/
#*    .../diffusion/article/flt/artifact/scripts/bglstone_flt1.sh      */
#*    -------------------------------------------------------------    */
#*    Author      :  Manuel Serrano                                    */
#*    Creation    :  Thu Oct  3 08:34:02 2024                          */
#*    Last change :  Sun Mar 16 06:20:10 2025 (serrano)                */
#*    Copyright   :  2024-25 Manuel Serrano                            */
#*    -------------------------------------------------------------    */
#*    bglstone download and installation                               */
#*=====================================================================*/
package=bglstone_flt1
color=33
...
if [ "$action " = "install " -o "$action " = "all " ]; then
  ...
  if [ ! -f ${downloaddir}/Makefile.config ]; then
    ...
    (cd $downloaddir; ./configure --bigloo=${rootdir}/bigloo_flt1/bin/bigloo --bflags="$bglstone_bflags" >> $log 2>&1) || exit 1
  fi
