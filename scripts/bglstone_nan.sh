#!/bin/sh
#*=====================================================================*/
#*    .../diffusion/article/flt/artifact/scripts/bglstone_nan.sh       */
#*    -------------------------------------------------------------    */
#*    Author      :  Manuel Serrano                                    */
#*    Creation    :  Thu Oct  3 08:34:02 2024                          */
#*    Last change :  Sun Mar 16 06:21:19 2025 (serrano)                */
#*    Copyright   :  2024-25 Manuel Serrano                            */
#*    -------------------------------------------------------------    */
#*    bglstone download and installation                               */
#*=====================================================================*/
package=bglstone_nan
color=34
...
if [ "$action " = "install " -o "$action " = "all " ]; then
  ...
  if [ ! -f ${downloaddir}/Makefile.config ]; then
    ...
    (cd $downloaddir; ./configure --bigloo=${rootdir}/bigloo_nan/bin/bigloo --bflags="$bglstone_bflags" >> $log 2>&1) || exit 1
  fi
