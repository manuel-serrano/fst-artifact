#!/bin/sh
#*=====================================================================*/
#*    .../diffusion/article/flt/artifact/scripts/bglstone_flt.sh       */
#*    -------------------------------------------------------------    */
#*    Author      :  Manuel Serrano                                    */
#*    Creation    :  Thu Oct  3 08:34:02 2024                          */
#*    Last change :  Sun Mar 16 06:19:50 2025 (serrano)                */
#*    Copyright   :  2024-25 Manuel Serrano                            */
#*    -------------------------------------------------------------    */
#*    bglstone download and installation                               */
#*=====================================================================*/
package=bglstone_flt
color=33
...
if [ "$action " = "install " -o "$action " = "all " ]; then
  ...
  if [ ! -f ${downloaddir}/Makefile.config ]; then
    ...
    (cd $downloaddir; ./configure --bigloo=${rootdir}/bigloo_flt/bin/bigloo --bflags="$bglstone_bflags" >> $log 2>&1) || exit 1
  fi
