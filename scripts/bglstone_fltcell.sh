#!/bin/sh
#*=====================================================================*/
#*    .../article/flt/artifact/scripts/bglstone_fltcell.sh             */
#*    -------------------------------------------------------------    */
#*    Author      :  Manuel Serrano                                    */
#*    Creation    :  Thu Oct  3 08:34:02 2024                          */
#*    Last change :  Thu Nov  7 07:33:29 2024 (serrano)                */
#*    Copyright   :  2024 Manuel Serrano                               */
#*    -------------------------------------------------------------    */
#*    bglstone download and installation                               */
#*=====================================================================*/
package=bglstone_fltcell
color=34
...
if [ "$action " = "install " -o "$action " = "all " ]; then
  ...
  if [ ! -f ${downloaddir}/Makefile.config ]; then
    ...
    configure --bigloo=${rootdir}/bigloo_fltcell/bin/bigloo || exit 1
  fi
