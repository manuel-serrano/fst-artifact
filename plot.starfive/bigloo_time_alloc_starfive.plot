...
plot \
   'bigloo_time_alloc_starfive.csv' u 2:3:4:xtic(1) title 'alloc' ls 1, \
   'bigloo_time_alloc_starfive.csv' u ($0+0):($2+.15):(sprintf("%3.2f",$2)) with labels font 'Verdana,4' rotate by 90 notitle
reset
