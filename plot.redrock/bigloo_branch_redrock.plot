...
plot \
  'bigloo_branch_redrock.csv' u 2:xtic(1) title 'Scheme self tagging (3 tags)1' ls 2,\
  'bigloo_branch_redrock.csv' u 3:xtic(1) title 'Scheme self tagging (2 tags)' ls 3,\
  'bigloo_branch_redrock.csv' u 4:xtic(1) title 'Scheme self tagging (3 tags)' ls 4,\
  'bigloo_branch_redrock.csv' u 5:xtic(1) title 'Scheme nan tagging' ls 5,\
  'bigloo_branch_redrock.csv' u 6:xtic(1) title 'orig_nun' ls 6,\
  'bigloo_branch_redrock.csv' u ($0+-0.5):($2+.3):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock.csv' u ($0+-0.3333333333333333):($2+.3):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock.csv' u ($0+-0.16666666666666666):($2+.3):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock.csv' u ($0+0):($2+.3):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock.csv' u ($0+0.16666666666666666):($2+.3):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle
