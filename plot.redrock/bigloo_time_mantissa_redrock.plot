...
plot \
   'bigloo_time_mantissa_redrock.csv' u 2:xtic(1) title 'self-tagging (2-tag, mantissa low-bits)' ls 1, \
   'bigloo_time_mantissa_redrock.csv' u ($0+0):($2+.15):(sprintf("%3.2f",$2)) with labels font 'Verdana,4' rotate by 90 notitle
reset
